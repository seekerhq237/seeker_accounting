"""
Generate February 2026 payslip for EMP001 (Amadou Koné).

Creates a fresh company, runs February 2026 payroll for all 4 demo employees,
and exports only EMP001's payslip to the project root.

Usage:
    python generate_february_payslip.py
"""
...
def main() -> None:
    ...
    print("=" * 65)
    print("  Seeker Accounting — February 2026 Payslip Generator")
    print("=" * 65)
    ...
    run = reg.payroll_run_service.create_run(
        ...
        CreatePayrollRunCommand(
            period_year=2026,
            period_month=2,
            run_label="February 2026 Payroll",
            currency_code="XAF",
    ...
    filename = f"payslip_FEB2026_{emp1.employee_number}_{safe_name}.pdf"
