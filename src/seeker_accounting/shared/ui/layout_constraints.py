...
WINDOW_SIZE_TOKENS: dict[str, WindowSizeToken] = {
    ...
    "modules.purchases.ui.purchase.bill.grn_match.dialog.0": WindowSizeToken("modules.purchases.ui.purchase.bill.grn_match.dialog.0", 880, 560),
    ...
    "modules.taxation.ui.company.tax.profile.dialog.0": WindowSizeToken("modules.taxation.ui.company.tax.profile.dialog.0", 800, 460),
