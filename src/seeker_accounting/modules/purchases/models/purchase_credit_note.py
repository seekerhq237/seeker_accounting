...
class PurchaseCreditNote(TimestampMixin, Base):
    __tablename__ = "purchase_credit_notes"
    __table_args__ = (
        UniqueConstraint("company_id", "credit_number"),
        Index("ix_purchase_credit_notes_company_id", "company_id"),
        Index("ix_purchase_credit_notes_company_id_supplier_id_credit_date", "company_id", "supplier_id", "credit_date"),
        Index("ix_purchase_credit_notes_company_id_status_code", "company_id", "status_code"),
    )
    ...
    source_bill: Mapped["PurchaseBill | None"] = relationship(
        "PurchaseBill",
        foreign_keys=[source_bill_id],
    )
    ...
    lines: Mapped[list["PurchaseCreditNoteLine"]] = relationship(
        "PurchaseCreditNoteLine",
        back_populates="purchase_credit_note",
