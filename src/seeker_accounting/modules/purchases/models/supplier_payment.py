...
class SupplierPayment(TimestampMixin, Base):
    ...
    __table_args__ = (
        UniqueConstraint("company_id", "payment_number"),
        Index("ix_supplier_payments_company_id", "company_id"),
        Index("ix_supplier_payments_company_id_supplier_id_payment_date", "company_id", "supplier_id", "payment_date"),
        Index("ix_supplier_payments_company_id_status_code", "company_id", "status_code"),
    )
