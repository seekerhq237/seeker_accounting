...
class CustomerQuoteLine(TimestampMixin, Base):
    __tablename__ = "customer_quote_lines"
    __table_args__ = (
        UniqueConstraint("customer_quote_id", "line_number"),
        Index("ix_customer_quote_lines_project_id", "project_id"),
        Index("ix_customer_quote_lines_project_job_id", "project_job_id"),
    )

    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    customer_quote_id: Mapped[int] = mapped_column(
        Integer,
