...
class SalesInvoiceLine(TimestampMixin, Base):
    __tablename__ = "sales_invoice_lines"
    __table_args__ = (
        UniqueConstraint("sales_invoice_id", "line_number"),
        Index("ix_sales_invoice_lines_project_id", "project_id"),
        Index("ix_sales_invoice_lines_project_job_id", "project_job_id"),
    )
    ...
    # P2 / Slice 3.1 – inventory item linkage (nullable for legacy lines)
    ...
    # P2 / Slice 3.2 – COGS fields (filled by posting service)
    ...
    sales_invoice: Mapped["SalesInvoice"] = relationship("SalesInvoice", back_populates="lines")
