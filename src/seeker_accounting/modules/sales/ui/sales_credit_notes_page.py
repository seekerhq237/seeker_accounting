...
class SalesCreditNotesPage(QWidget):
    def __init__(self, service_registry: ServiceRegistry, parent: QWidget | None = None) -> None:
        ...
        self._notes: list[SalesCreditNoteListItemDTO] = []

        self.setObjectName("SalesCreditNotesPage")
    ...
    def reload(self, selected_id: int | None = None) -> None:
        ...
        try:
            self._notes = self._service_registry.sales_credit_note_service.list_credit_notes(
                active.company_id,
            ...
            self._update_action_state()
            show_error(self, "Sales Credit Notes", f"Could not load credit notes.\n\n{exc}")
            return
    ...
    def _build_content_stack(self) -> QStackedWidget:
        ...
        nc_label = QLabel("Select an active company to view sales credit notes.", self._no_company_state)
    ...
    def _handle_new(self) -> None:
        ...
        if active is None:
            ...
            return
        result = SalesCreditNoteDialog.create_credit_note(
    ...
    def _handle_edit(self) -> None:
        ...
        if active is None:
            return
        result = SalesCreditNoteDialog.edit_credit_note(
    ...
    def _handle_post(self) -> None:
        ...
        if reply != QMessageBox.StandardButton.Yes:
            return
        try:
            result = self._service_registry.sales_credit_note_posting_service.post_credit_note(
    ...
    def _handle_cancel(self) -> None:
        ...
        if active is None:
            return
        try:
            self._service_registry.sales_credit_note_service.cancel_credit_note(active.company_id, note_id)
            self.reload()
        except (ValidationError, NotFoundError, ConflictError) as exc:
