...
class TreasuryTransactionsPage(QWidget):
    ...
    def reload_transactions(self, selected_transaction_id: int | None = None) -> None:
        ...
        try:
            self._transactions = self._service_registry.treasury_transaction_service.list_treasury_transactions(
    ...
    def _populate_toolbar_strip(self, register: RegisterPage) -> None:
        ...
        self._status_filter_combo.currentIndexChanged.connect(lambda _index: self.reload_transactions())
        ...
        self._type_filter_combo.currentIndexChanged.connect(lambda _index: self.reload_transactions())
    ...
    def _populate_table(self) -> None:
        ...
        self._record_count_label.setText(
            f"{count} transaction" if count == 1 else f"{count} transactions"
        )
