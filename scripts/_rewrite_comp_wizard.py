...
with open("src/seeker_accounting/modules/payroll/ui/wizards/compensation_change_wizard.py") as f:
    lines = f.readlines()

# Keep lines 0-108 (the module header, imports, dataclasses, step IDs, _card helper)
header = "".join(lines[:109])
    ...
    def _apply_change(self) -> None:
        ...
        if isinstance(comp_id, int):
            ...
            try:
                ...
                # Profile was created — surface as warning; change is still applied.
                self.set_step_issues(
                    _STEP_REVIEW,
                    [
                        ValidationIssue(
...
with open("src/seeker_accounting/modules/payroll/ui/wizards/compensation_change_wizard.py", "w") as f:
