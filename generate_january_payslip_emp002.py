"""
Generate January 2026 payslip for EMP002 (Fatoumata Mbaye).
...
Usage:
    python generate_january_payslip_emp002.py
"""
...
def main() -> None:
    ...
    print("=" * 65)
    print("  Seeker Accounting — January 2026 Payslip Generator (EMP002)")
    print("=" * 65)
    ...
    filename = f"payslip_JAN2026_{target.employee_number}_{safe_name}.pdf"
